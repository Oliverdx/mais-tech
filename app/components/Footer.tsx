...
function Footer() {
  return <footer className="bg-main_red w-full py-10 mt-10">
    <div className="flex flex-col align-center w-11/12 mx-auto justify-center text-white md:flex-row">
      <Image
        src="/images/logo-white.png"
        alt="Mais Tech Logo White"
        width={300}
        height={80}
        className="w-[250px] pr-8 m-8 md:border-r-1 md:border-white"
      />
